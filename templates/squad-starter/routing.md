...
|-----------|----------|----------|
| General tasks, triage, coordination | {Lead Name} | "What should I work on?", prioritize tasks, scope decisions |
| Building features, scripts, tools | {Developer Name} | "Build X", "Automate Y", implement a feature |
| Testing, quality checks, edge cases | {Tester Name} | "Write tests for X", "Verify this works", find regressions |
| Documentation, reports, summaries | {Documentarian Name} | "Write a doc for X", "Summarize this", create guides |
| Code review, PR quality gates | {Reviewer Name} | Review PRs, check quality, verify acceptance criteria |
| Scope & priorities | {Lead Name} | What to build next, trade-offs, decisions |
